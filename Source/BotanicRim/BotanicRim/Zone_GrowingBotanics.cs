...
{
    public class Zone_GrowingBotanics : Zone, IPlantToGrowSettable
    {
        ...
        {
            yield return DesignatorUtility.FindAllowedDesignator<Designator_ZoneAdd_GrowingBotanics_Expand>();
        }
