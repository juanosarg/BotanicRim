...
namespace BotanicRim
{
    ...
    public static class PipeOverlayMats
    {
        ...
        static PipeOverlayMats()
        {
            ...
            MatConnectorBase = MaterialPool.MatFrom("Things/Special/Fluid/BR_OverlayBase", ShaderDatabase.MetaOverlay);
            ...
            Graphic graphic = GraphicDatabase.Get<Graphic_Single>("Things/Special/Fluid/BR_BlankTransmitterAtlas", TransmitterShader);
