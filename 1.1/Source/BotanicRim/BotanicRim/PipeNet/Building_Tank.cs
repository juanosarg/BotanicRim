...
namespace BotanicRim
{
    ...
    public class Building_Tank : Building
    {
        ...
        private static readonly Vector2 BarSize = new Vector2(0.8f, 0.3f);
        ...
        private static readonly Material BatteryBarFilledMat = SolidColorMaterials.SimpleSolidColorMaterial(new Color(0.05f, 0.35f, 0.05f), false);
